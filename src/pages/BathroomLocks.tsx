...
import bathroomLocksImg from "@/assets/bathroom-locks.jpg";
      ...
      <main className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-foreground mb-4">Bathroom Locks</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Specialized bathroom locks designed for privacy and safety in wet environments.
              All locks feature corrosion-resistant finishes and emergency release mechanisms.
            </p>
          </div>
